...
filenames = {'int': './internal.xlsx', 'pb': './pb.xlsx', 'admin': './admin.xlsx'}
...
df_admin = df_admin[df_admin['Type'] == 'Bond']
...
# print(df_admin['ISIN'='US105756BY51'])
# print(df_int['ISIN'='US105756BY51'])

""" optional write to csv """
# df_agg_results.to_csv(r'csv_results' + filename_time + '.csv')
# df_admin.to_csv(r'csv_admin_map' + filename_time + '.csv')
# df_int.to_csv(r'csv_internal_map' + filename_time + '.csv')
